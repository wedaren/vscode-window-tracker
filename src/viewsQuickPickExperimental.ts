...
export async function openViewsQuickPickExperimental(
  ...
  qp.placeholder = `选择视图并按 Enter 聚焦 · 已隐藏 ${hiddenIds.length} 项` + (hiddenIds.length > 0 ? ' · 可在 Navigator TreeView 中管理' : '');
